...
import com.daily.health.manager.databinding.FcDialogAlarmTimeSelectBinding
import com.healthtracker.framework.base.fragment.BaseBottomSheetDialogFragment
import com.healthtracker.framework.ext.click
import com.healthtracker.framework.util.getRobotoBold

class AlarmTimeSelectDialog(private val def: Pair<Int,Int>? = null,private val callBack:((Pair<Int, Int>)-> Unit)? = null) : BaseBottomSheetDialogFragment<FcDialogAlarmTimeSelectBinding>() {
    ...
    ) = FcDialogAlarmTimeSelectBinding.inflate(inflater, parent, attachToParent)
