...
fun AlarmListContent(
    ...
    val bsTitle = stringResource(R.string.ht_blood_suger)
    val bpTitle = stringResource(R.string.ht_blood_pressure)
    val hrTitle = stringResource(R.string.ht_heart_rate)
    val bmiTitle = stringResource(R.string.ht_bmi)
    val cholTitle = stringResource(R.string.ht_cholesterol)

    Scaffold(
        topBar = {
            HealthTopBar(
                title = stringResource(R.string.ht_alarm_management),
                onBack = onBack
            )
        },
...
fun AlarmCategoryHeader(
    ...
    Row(
        ...
        IconButton(
            ...
            Icon(
                painter = painterResource(id = R.drawable.ht_ic_alarm_add),
