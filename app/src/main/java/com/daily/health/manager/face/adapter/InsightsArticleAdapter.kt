...
import com.daily.health.manager.databinding.FcItemInsightsBinding
...
class InsightsArticleAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArticleViewHolder {
        val binding = FcItemInsightsBinding.inflate(
    ...
    inner class ArticleViewHolder(
        private val binding: FcItemInsightsBinding
        ...
        fun bind(article: InsightAssetPreparer.InsightArticle) {
            ...
            if (imagePath.isNullOrEmpty()) {
                binding.ivImg.setImageResource(R.drawable.fc_bg_rect_white_12)
            } else {
