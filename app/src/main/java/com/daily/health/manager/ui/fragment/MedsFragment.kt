...
import com.daily.health.manager.ui.act.AddReminderActivity
import com.daily.health.manager.ui.adapter.MedsReminderAdapter
import com.daily.health.manager.ui.dialog.ConfirmDialog
import com.daily.health.manager.ui.model.MedsReminderItem
import com.daily.health.manager.ui.viewmodel.MedsViewModel
import com.daily.health.manager.ui.widget.MedsRemindDropdownMenu
import com.daily.health.manager.ui.widget.MenuAction
...
//
//         // 如果尚未服药，可以标记为已服药
//         if (item.status == com.daily.health.manager.ui.model.ReminderStatus.PENDING) {
