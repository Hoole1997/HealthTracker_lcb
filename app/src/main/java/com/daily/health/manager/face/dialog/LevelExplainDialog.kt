...
import com.daily.health.manager.databinding.FcDialogLevelExplainBinding
...
class LevelExplainDialog(
...
) : BaseBottomSheetDialogFragment<FcDialogLevelExplainBinding>() {
    ...
    ) = FcDialogLevelExplainBinding.inflate(inflater, parent, attachToParent)
