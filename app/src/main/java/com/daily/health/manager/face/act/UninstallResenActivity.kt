...
import com.daily.health.manager.databinding.HtActivityUninstallResenBinding
...
class UninstallResenActivity : BaseMVVMActivity<BaseViewModel, HtActivityUninstallResenBinding>() {
    ...
    override fun createViewBinding() = HtActivityUninstallResenBinding.inflate(layoutInflater)
...
private fun UninstallResenScreen(
    ...
    val features = listOf(
        FeatureItem(R.drawable.ht_ic_bs_primery, R.string.ht_uninstall_feature_blood_sugar),
        FeatureItem(R.drawable.ht_ic_statistical, R.string.ht_uninstall_feature_trend),
        FeatureItem(R.drawable.ht_ic_meds, R.string.ht_uninstall_feature_reminder),
        FeatureItem(R.drawable.ht_ic_tips, R.string.ht_uninstall_feature_insights)
    )
    ...
    Column(
        ...
        Column(
            ...
            // Illustration
            Image(
                painter = painterResource(R.drawable.ht_ic_placeholder_uninstall),
            ...
            // Title
            Text(
                text = stringResource(R.string.ht_uninstall_lose_access_title),
                fontSize = 16.sp,
