...
enum class CholesterolLevel(
     ...
     */
    UNKNOWN(
        labelRes = R.string.tr_cholesterol_level_unknown,
        descriptionRes = R.string.tr_cholesterol_level_unknown_desc,
     ...
     */
    NORMAL(
        labelRes = R.string.tr_cholesterol_level_normal,
        descriptionRes = R.string.tr_cholesterol_level_normal_desc,
     ...
     */
    NEAR_OPTIMAL(
        labelRes = R.string.tr_cholesterol_level_near_optimal,
        descriptionRes = R.string.tr_cholesterol_level_near_optimal_desc,
     ...
     */
    BORDERLINE(
        labelRes = R.string.tr_cholesterol_level_borderline,
        descriptionRes = R.string.tr_cholesterol_level_borderline_desc,
     ...
     */
    HIGH(
        labelRes = R.string.tr_cholesterol_level_high,
        descriptionRes = R.string.tr_cholesterol_level_high_desc,
     ...
     */
    VERY_HIGH(
        labelRes = R.string.tr_cholesterol_level_very_high,
        descriptionRes = R.string.tr_cholesterol_level_very_high_desc,
