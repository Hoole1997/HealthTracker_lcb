...
//            String subject = context.getString(R.string.tr_feedback_email_title, context.getString(R.string.app_name));
...
//            } catch (Throwable e2) {
//                Toast.makeText(context.getApplicationContext(), context.getString(R.string.tr_feedback_sending_failed), Toast.LENGTH_SHORT).show();
//            }
//        }
//    }
//
