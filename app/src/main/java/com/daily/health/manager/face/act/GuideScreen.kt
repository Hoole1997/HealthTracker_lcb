...
import com.daily.health.manager.databinding.HtActivityGuideBinding
import com.daily.health.manager.databinding.HtFragmentGuide1Binding
import com.daily.health.manager.databinding.HtFragmentGuide2Binding
import com.daily.health.manager.databinding.HtFragmentGuide3Binding
import com.daily.health.manager.saveHasNewGuide
import com.daily.health.manager.utils.loadFullNative
...
class GuideScreen : BaseMVVMActivity<BaseViewModel, HtActivityGuideBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        with(mViewBind) {
            ...
            viewpager.adapter = GuidePageAdapter(frags, this@GuideScreen)
            ...
            indicatorView.apply {
                setSliderColor(ContextCompat.getColor(this@GuideScreen,R.color.color_F1F1F0), ContextCompat.getColor(this@GuideScreen,R.color.c5))
