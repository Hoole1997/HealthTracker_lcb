...
public class CircleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private void init(Context ctx, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = ctx.obtainStyledAttributes(attrs, R.styleable.CircleImageView);

            borderWidth = a.getDimension(R.styleable.CircleImageView_borderWidth, borderWidth);
            mBorderColorStateList = a.getColorStateList(R.styleable.CircleImageView_borderColor);
            displayBorder = a.getBoolean(R.styleable.CircleImageView_displayBorder, displayBorder);

            leftTopRadius = a.getDimension(R.styleable.CircleImageView_android_topLeftRadius, leftTopRadius);
            rightTopRadius = a.getDimension(R.styleable.CircleImageView_android_topRightRadius, rightTopRadius);
            leftBottomRadius = a.getDimension(R.styleable.CircleImageView_android_bottomLeftRadius, leftBottomRadius);
            rightBottomRadius = a.getDimension(R.styleable.CircleImageView_android_bottomRightRadius, rightBottomRadius);

            float radius = a.getDimension(R.styleable.CircleImageView_android_radius, 0);
            if (radius > 0)
                leftTopRadius = leftBottomRadius = rightTopRadius = rightBottomRadius = radius;

            int index = a.getInt(R.styleable.CircleImageView_displayType, -1);
            ...
            displayLabel = a.getBoolean(R.styleable.CircleImageView_displayLabel, displayLabel);
            labelText = a.getString(R.styleable.CircleImageView_android_text);
            mLabelBackColorStateList = a.getColorStateList(R.styleable.CircleImageView_labelBackground);
            textSize = a.getDimensionPixelSize(R.styleable.CircleImageView_android_textSize, textSize);
            mTextColorStateList = a.getColorStateList(R.styleable.CircleImageView_android_textColor);
            labelWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_labelWidth, labelWidth);
            labelGravity = a.getInt(R.styleable.CircleImageView_labelGravity, labelGravity);
            startMargin = a.getDimensionPixelSize(R.styleable.CircleImageView_startMargin, startMargin);

            mGradientType = a.getInt(R.styleable.CircleImageView_android_type, GRADIENT_LINEAR_TYPE);
            mStartColor = a.getColorStateList(R.styleable.CircleImageView_android_startColor);
            mCenterColor = a.getColorStateList(R.styleable.CircleImageView_android_centerColor);
            mEndColor = a.getColorStateList(R.styleable.CircleImageView_android_endColor);
            mGradientContent = a.getInt(R.styleable.CircleImageView_gradientContent, GRADIENT_NONE);
            mOrientation = a.getInt(R.styleable.CircleImageView_android_orientation, LinearLayout.HORIZONTAL);

            final int typefaceIndex = a.getInt(R.styleable.CircleImageView_android_typeface, -1);
            final int styleIndex = a.getInt(R.styleable.CircleImageView_android_textStyle, -1);
     ...
     *                        {@link CircleImageView#GRADIENT_NONE,
     * @link CircleImageView#GRADIENT_BORDER,
     * @link CircleImageView#GRADIENT_LABEL,
     * @link CircleImageView#GRADIENT_LABEL_BACKGROUND,
     * @link CircleImageView#GRADIENT_ALL}
     */
