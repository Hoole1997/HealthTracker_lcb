...
class WeeklyDateSelector @JvmOverloads constructor(
    ...
    private val root: View = inflater.inflate(R.layout.ht_layout_weekly_date_selector, this, true)
    ...
    private var dayNumberSelectedBackgroundResId: Int = R.drawable.ht_bg_week_day_selected
    private var dayNumberNormalBackgroundResId: Int = R.drawable.ht_bg_week_day_normal
    ...
    private inner class WeekViewHolder(private val container: LinearLayout) : RecyclerView.ViewHolder(container) {
        ...
        fun bind(weekStartDate: Date) {
            ...
            for (i in 0..6) {
                ...
                val dayView = inflater.inflate(R.layout.ht_item_week_day, null)
