...
import com.daily.health.manager.databinding.FcDialogDosesTimesBinding
...
class DosesTimesDialog(private val def: Int = 3,private val callBack: ((Int) -> Unit)? = null) :
    BaseVbDialogFragment<FcDialogDosesTimesBinding>() {
    ...
    ) = FcDialogDosesTimesBinding.inflate(layoutInflater)
