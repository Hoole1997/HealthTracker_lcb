...
import com.daily.health.manager.databinding.FcDialogExitBinding
...
class ExitDialog(private val onExit:(() -> Unit)? = null): BaseBottomSheetDialogFragment<FcDialogExitBinding>() {
    ...
    ) = FcDialogExitBinding.inflate(layoutInflater,parent,attachToParent)
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        mViewBind?.apply {
            ...
            skeleton = ViewSkeletonScreen.Builder(adContainer)
                .load(R.layout.fc_layout_skeleton_ad)
                .shimmer(true)
                .angle(30)
                .duration(1200)
