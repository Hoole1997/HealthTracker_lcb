package com.daily.health.manager.ui.fragment
...
import com.daily.health.manager.ui.act.FeedbackActivity
import com.daily.health.manager.ui.act.InnerWebActivity
import com.daily.health.manager.ui.act.LanguageActivity
import com.daily.health.manager.ui.act.ProfileActivity
import com.daily.health.manager.ui.act.TargetRangeActivity
import com.daily.health.manager.ui.dialog.ComingSoonDialog
    ...
    private fun handleAction(action: SettingsAction) {
        when (action) {
            SettingsAction.AlarmManagement -> {
                startActivity(Intent(requireContext(), AlarmManageActivity::class.java))
            }
            ...
            SettingsAction.TargetRangeSettings -> {
                startActivity(Intent(requireContext(), TargetRangeActivity::class.java))
            }
            ...
            SettingsAction.Language -> {
                languageSelectLauncher.launch(Intent(requireContext(), LanguageActivity::class.java).apply {
            ...
            SettingsAction.PrivacyPolicy -> {
                InnerWebActivity.start(requireContext(), BuildConfig.PRIVACY_POLICY)
            }
