...
object HealthTipsProvider {
    ...
    fun pickRandom(metric: HealthMetric): HealthTips {
        val (titlesRes, textsRes) = when (metric) {
            HealthMetric.BLOOD_PRESSURE -> R.array.tr_health_tips_blood_pressure_titles to R.array.tr_health_tips_blood_pressure_texts
            HealthMetric.BLOOD_SUGAR -> R.array.tr_health_tips_blood_sugar_titles to R.array.tr_health_tips_blood_sugar_texts
            HealthMetric.CHOLESTEROL -> R.array.tr_health_tips_cholesterol_titles to R.array.tr_health_tips_cholesterol_texts
            HealthMetric.HEART_RATE -> R.array.tr_health_tips_heart_rate_titles to R.array.tr_health_tips_heart_rate_texts
            HealthMetric.BMI -> R.array.tr_health_tips_bmi_titles to R.array.tr_health_tips_bmi_texts
            HealthMetric.STEPS -> R.array.tr_health_tips_steps_titles to R.array.tr_health_tips_steps_texts
            HealthMetric.HYDRATION -> R.array.tr_health_tips_hydration_titles to R.array.tr_health_tips_hydration_texts
        }
