...
enum class BmiUnit(
    ...
    companion object {
        ...
        fun getWeightUnitLabel() = if (getPreferredWeightUnit() == METRIC) {
            App.INSTANCE.getString(R.string.fc_unit_kg)
        } else {
            App.INSTANCE.getString(R.string.fc_unit_lb)
        }

        fun getHeightUnitLabel() = if (getPreferredWeightUnit() == METRIC) {
            App.INSTANCE.getString(R.string.fc_unit_cm)
        } else {
            App.INSTANCE.getString(R.string.fc_unit_ft_in)
        }
    }
