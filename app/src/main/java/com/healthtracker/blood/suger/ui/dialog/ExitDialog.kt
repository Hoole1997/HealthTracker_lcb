...
import com.healthtracker.blood.suger.databinding.DialogExitBinding
...
class ExitDialog(private val onExit:(() -> Unit)? = null): BaseBottomSheetDialogFragment<DialogExitBinding>() {
    ...
    ) = DialogExitBinding.inflate(layoutInflater,parent,attachToParent)
