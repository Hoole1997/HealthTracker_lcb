...
class MaxHeightFrameLayout @JvmOverloads constructor(
    ...
    init {
        context.theme.obtainStyledAttributes(attrs, com.healthtracker.blood.suger.R.styleable.MaxHeightFrameLayout, 0, 0).apply {
            maxHeight = getDimensionPixelSize(
                com.healthtracker.blood.suger.R.styleable.MaxHeightFrameLayout_maxHeight,
