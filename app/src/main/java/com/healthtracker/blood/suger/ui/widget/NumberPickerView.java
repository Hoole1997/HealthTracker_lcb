...
public class NumberPickerView extends View {
    ...
    private TextPaint mPaintSelectedText = new TextPaint();
    ...
    private void init(Context context) {
        ...
        this.mPaintSelectedText.setColor(this.mTextColorNormal);
        this.mPaintSelectedText.setAntiAlias(true);
        this.mPaintSelectedText.setTextAlign(Align.CENTER);
    ...
    public void setContentSelectedTextTypeface(Typeface typeface) {
        this.mPaintSelectedText.setTypeface(typeface);
    }
    ...
    private void updateFontAttr() {
        ...
        if (this.mPaintHint == null) {
            ...
            if (this.mPaintText == null) {
                ...
                this.mPaintSelectedText.setTextSize((float)this.mTextSizeSelected);
                this.mTextSizeSelectedCenterYOffset = this.getTextCenterYOffset(this.mPaintSelectedText.getFontMetrics());
    ...
    private void drawContent(Canvas canvas) {
        ...
        for(int i = 0; i < this.mShownCount + 1; ++i) {
            ...
            if (i == this.mShownCount / 2) {
                ...
                picked = true;
            } else if (i == this.mShownCount / 2 + 1) {
            ...
            this.mPaintSelectedText.setColor(textColor);
            this.mPaintSelectedText.setTextSize(textSize);
            if (0 <= index && index < this.getOneRecycleSize()) {
                CharSequence str = this.formatDisplayValue(this.mDisplayedValues[index + this.mMinShowIndex]);
                if (this.mTextEllipsize != null) {
                    str = TextUtils.ellipsize(str, picked ? this.mPaintSelectedText : this.mPaintText, (float)(this.getWidth() - 2 * this.mItemPaddingHorizontal), this.getEllipsizeType());
                }

                canvas.drawText(str.toString(), this.mViewCenterX, y + (float)(this.mItemHeight / 2) + textSizeCenterYOffset, picked ? this.mPaintSelectedText : this.mPaintText);
    ...
    private String formatDisplayValue(String value) {
        return this.mFormatter != null ? this.mFormatter.format(value) : value;
    }
