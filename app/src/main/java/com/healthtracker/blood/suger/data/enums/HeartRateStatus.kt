...
enum class HeartRateStatus(
    ...
    NORMAL(
        minInclusive = 60,
        maxInclusive = 100,
        statusTextRes = R.string.heart_rate_status_normal,
        descriptionRes = R.string.heart_rate_desc_normal,
        colorRes = R.color.color_05BA7B
    ),
    FAST(
        minInclusive = 101,
        maxInclusive = null,
        statusTextRes = R.string.heart_rate_status_fast,
        descriptionRes = R.string.heart_rate_desc_fast,
