...
object WeatherIconMapper {
    ...
    fun getIconDescriptionRes(iconId: Int?): Int {
        return when (iconId) {
            1 -> R.string.weather_sunny
            2 -> R.string.weather_mostly_sunny
            3 -> R.string.weather_partly_sunny
            4 -> R.string.weather_intermittent_clouds
            5 -> R.string.weather_hazy_sunshine
            6 -> R.string.weather_mostly_cloudy
            7 -> R.string.weather_cloudy
            8 -> R.string.weather_overcast
            11 -> R.string.weather_fog
            12 -> R.string.weather_showers
            13 -> R.string.weather_mostly_cloudy_w_showers
            14 -> R.string.weather_partly_sunny_w_showers
            15 -> R.string.weather_t_storms
            16 -> R.string.weather_mostly_cloudy_w_t_storms
            17 -> R.string.weather_partly_sunny_w_t_storms
            18 -> R.string.weather_rain
            19 -> R.string.weather_flurries
            20 -> R.string.weather_mostly_cloudy_w_flurries
            21 -> R.string.weather_partly_sunny_w_flurries
            22 -> R.string.weather_snow
            23 -> R.string.weather_mostly_cloudy_w_snow
            24 -> R.string.weather_ice
            25 -> R.string.weather_sleet
            26 -> R.string.weather_freezing_rain
            29 -> R.string.weather_rain_and_snow
            30 -> R.string.weather_hot
            31 -> R.string.weather_cold
            32 -> R.string.weather_windy
            33 -> R.string.weather_clear
            34 -> R.string.weather_mostly_clear
            35 -> R.string.weather_partly_cloudy
            36 -> R.string.weather_intermittent_clouds
            37 -> R.string.weather_hazy_moonlight
            38 -> R.string.weather_mostly_cloudy
            39 -> R.string.weather_partly_cloudy_w_showers
            40 -> R.string.weather_mostly_cloudy_w_showers
            41 -> R.string.weather_partly_cloudy_w_t_storms
            42 -> R.string.weather_mostly_cloudy_w_t_storms
            43 -> R.string.weather_mostly_cloudy_w_flurries
            44 -> R.string.weather_mostly_cloudy_w_snow
