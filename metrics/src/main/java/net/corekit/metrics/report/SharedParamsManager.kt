...
object SharedParamsManager {
    ...
    private const val KEY_AD_NETWORK = "pdf_n6p9h4t2"
    private const val KEY_CAMPAIGN = "pdf_o3x5r8w1"
    private const val KEY_ADGROUP = "pdf_p7y2m6k9"
    private const val KEY_CREATIVE = "pdf_q4z8j3v5"
