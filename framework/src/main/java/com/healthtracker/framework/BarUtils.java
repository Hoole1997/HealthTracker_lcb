...
public final class BarUtils {
    ...
    public static int getStatusBarHeight(Context activity) {
        return SysBarUtils.INSTANCE.getStatusBarHeight(activity);
    }
    ...
    public static void setStatusBarColor(@NonNull final View fakeStatusBar,
        ...
        layoutParams.height = getStatusBarHeight(fakeStatusBar.getContext());
    ...
    public static void setStatusBarCustom(@NonNull final View fakeStatusBar) {
        ...
        if (layoutParams == null) {
            layoutParams = new ViewGroup.LayoutParams(
                    ...
                    getStatusBarHeight(fakeStatusBar.getContext())
            );
